...
class TSMixer(nn.Module):
    def __init__(self, seq_len, pred_len, enc_in):
        ...
        self.rev = TSMRevIN(enc_in)

        self.backbone = TSMBackbone(seq_len, pred_len, enc_in)
