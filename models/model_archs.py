...
class Backbone(nn.Module):
    def __init__(self, seq_len=96, pred_len=96, patch_len=16, stride=8, padding_patch='end'):
        ...
        # Patching
        self.patch_len = patch_len = patch_len # 16
        self.stride = stride = stride  # 8
...
class PatchMixer(nn.Module):
    def __init__(self, enc_in=13, seq_len=96, pred_len=96):
        ...
        self.backbone = Backbone(seq_len, pred_len)
